(function() {
  ...
  function dataservice($http, $q, exception, logger) {
    ...
    function setImageForCoupon(id, data) {
         var url = 'http://disshopapp.azurewebsites.net/api/coupon/' + id + '/set-image/' + data.Id;
      return $http.get(url)
        .then(success)
        .catch(fail);
   ...
   //Discount Card Api
    ...
    function setFrontImageForDiscountCard(id, data) {
         var url = 'http://disshopapp.azurewebsites.net/api/discountcard/' + id + '/set-frontimage/' + data.Id;
      return $http.get(url)
        .then(success)
        .catch(fail);
    ...
    function setBackImageForDiscountCard(id, data) {
         var url = 'http://disshopapp.azurewebsites.net/api/discountcard/' + id + '/set-backimage/' + data.Id;
      return $http.get(url)
        .then(success)
        .catch(fail);
